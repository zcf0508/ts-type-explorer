...
import type { TypescriptContext } from './types';
 ...
 * @internal
 */
export function getTypeConstructor({ ts }: TypescriptContext): TypeConstructor {
 ...
 * @internal
 */
export function getSymbolConstructor({ ts }: TypescriptContext): SymbolConstructor {
  // @ts-expect-error - objectAllocator exists but is not exposed by types publicly

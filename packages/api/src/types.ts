...
interface CustomTypescriptResponseBodyData {
  id: 'type-tree'
  typeInfo: TypeInfo | undefined
}

export interface CustomTypeScriptResponse<
...
export interface LocalizedTypeInfoError {
  error: Error
  typeInfo?: TypeInfo
}
 ...
 * @internal
 */
export interface ResolvedArrayTypeInfo {
...
export interface LocalizedSymbolInfo {
  name: string
  anonymous?: boolean
  insideClassOrInterface?: boolean
  property?: boolean
 ...
 * @internal
 */
export interface TypeTreeContext {
 ...
 * @internal
 */
export interface TypeTreeOptions {
  optional?: boolean
  isRest?: boolean
  insideClassOrInterface?: boolean
}
 ...
 * @internal
 */
export interface RecursiveExpandContext {
 ...
 * @internal
 */
export interface IndexInfoMerged {
 ...
 * @internal
 */
export interface DiscriminatedIndexInfo {
  type: IndexInfoType

...
export class TypeInfoResolver {
  ...
  private async localizeWorker(info: TypeInfo): Promise<LocalizedTypeInfo> {
  ...
  private getTypeInfoMap(info: TypeInfo): TypeInfoMap {

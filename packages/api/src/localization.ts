import type { LocalizableKind, PrimitiveKind, TypePurpose } from './types';
...
export function getKindText(
  ...
  }, KindText[kind === 'function' && insideClassOrInterface
    ? 'method'
    : isJSXElement
      ? (kind === 'function'
        ? 'jsx_component'
...
export function getPrimitiveKindText(kind: PrimitiveKind): string {
